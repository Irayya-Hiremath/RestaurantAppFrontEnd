...
export default function NavBar() {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <Link className='mr-5 hover:text-gray-900' href={'/restaurants/listRestaurants'}>  Restaurants
      </Link>
      
      <Link className='mr-5 hover:text-gray-900' href={'/restaurants/addNewRestaurants'}> Add Restaurant
      </Link>
